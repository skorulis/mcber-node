...
module.exports = (app,passport) => {
	app.get('/api/user/current',passport.authenticate("jwt-verify"), controllers.userAccount.current);
  app.post('/api/user/update',passport.authenticate("jwt-verify"),controllers.userAccount.update);
  app.post('/api/user/refreshToken',auth.decodeToken, controllers.userAccount.refreshToken);

  app.post('/api/login/fb',passport.authenticate('facebook-token'),controllers.userAccount.loginComplete);
  ...
  app.post("/api/user/setOptions",passport.authenticate("jwt-verify"),controllers.userActions.setOptions);
